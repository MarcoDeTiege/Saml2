...
namespace Sustainsys.Saml2.Configuration
{
    ...
    public class SPOptions
    {
        ...
        /// <summary>
        /// ArtifactResolver Function that receives Uri:Destination and string:Message and returns string:Response
        /// </summary>
        public Func<Uri, string, string> ArtifactResolver { get; set; }
